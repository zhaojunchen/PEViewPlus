...
namespace uthenticode {
    ...
    struct CertificateTable{
        uint32_t dwLength;          //Specifies the length of the attribute
        ...
        uint8_t bCertificate[0];    //Contains a certificate, such as an Authenticode signature
    };

    bool verify(uint8_t* certificateTable, uint32_t certLength);
}  // namespace uthenticode
